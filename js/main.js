$(document).ready(function(){
  ...
  /*Script del btn de oferta educativa*/
  $('.btm-mega-menu1').click(function(e){
    e.preventDefault();
 		var megamenu1=$(".mega-menu1");
 		if(megamenu1.css("opacity")=="0"){ 
 			megamenu1.addClass("show-mega-menu1"); 
 			$('.btm-mega-menu1').css({ "color":"#FFA726" });
 		}else{ 
 			megamenu1.removeClass("show-mega-menu1");
 			$('.btm-mega-menu1').css({ "color":"#fff" });
 		}
  }); 
